...
**NOTE:** To ensure that the `zgsm-ai.zgsm` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

```json
"extensionDependencies": ["zgsm-ai.zgsm"]
```
