...
Output only the summary of the conversation so far, without any additional commentary or explanation.`,
	...
	WORKFLOW_TASK_RUN: {
		template: `Run the following workflow:
...
`,
	...
	WORKFLOW_TASK_RETRY: {
		template: `Retry the following workflow:
请开始执行用户需求的实现工作。基于已创建的需求文档(\${scope}/requirements.md)、架构设计文档(\${scope}/design.md)和任务规划文档(\${scope}/tasks.md)，逐步推进功能实现。
...
## 变更实施要求：
1. 首先更新需求文档，明确记录变更内容和原因
2. 评估设计文档需要调整的部分，更新相应的架构设计
3. 重新规划受影响的任务，调整任务优先级和依赖关系
...
## 变更实施要求：
1. 首先更新设计文档，明确记录变更内容和原因
2. 评估任务规划文档需要调整的部分，更新相应的任务规划设计
3. 重新规划受影响的任务，调整任务优先级和依赖关系
