...
export const features: Feature[] = [
	...
	},
	{
		...
		description:
			"Security-first from the ground up, Costrict meets rigorous standards without slowing you down. Monitoring and strict policies keep your code safe at scale.",
	},
	{
		icon: <Zap className="h-6 w-6 text-white" />,
		title: "Seamless Setup and Workflows",
		description:
			"Get started in minutes—no heavy configs. Costrict fits alongside your existing tools and dev flow, while supercharging your productivity.",
	},
]
